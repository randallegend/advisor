    ...
    <AuthLayout>
      <div className="glass rounded-3xl p-8 shadow-2xl shadow-[#8A2BE2]/10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#3C0E66]">Create account</h1>
          <p className="text-[#561493]/70 mt-2">Start building smarter campaigns today</p>
        </div>
        ...
        <form action={handleSubmit} className="space-y-5">
          <div>
            <label htmlFor="fullName" className="block text-sm font-medium text-[#3C0E66] mb-2">
              Full name
            </label>
            <input
              id="fullName"
          ...
          <div>
            <label htmlFor="confirmPassword" className="block text-sm font-medium text-[#3C0E66] mb-2">
              Confirm password
            </label>
            <input
              id="confirmPassword"
        ...
        <div className="relative my-8">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-white/70 text-[#561493]/70">Already have an account?</span>
          </div>
        </div>
